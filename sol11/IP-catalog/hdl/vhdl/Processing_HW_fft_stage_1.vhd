...
attribute shreg_extract : string;
    ...
    signal tmp_fu_74_p3 : STD_LOGIC_VECTOR (19 downto 0);
    signal tmp_reg_88 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    tmp_reg_88(19 downto 9) <= tmp_fu_74_p3(19 downto 9);
            end if;
        end if;
    end process;
    tmp_reg_88(8 downto 0) <= "000000000";

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numFFT_empty_n, num_c39_full_n, grp_fft_stage_1_Pipeline_stage_1_counter_stage_1_total_fu_56_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((real_start = ap_const_logic_0) or (num_c39_full_n = ap_const_logic_0) or (numFFT_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    begin
        if (((real_start = ap_const_logic_0) or (num_c39_full_n = ap_const_logic_0) or (numFFT_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) then 
    ...
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (num_c39_full_n = ap_const_logic_0) or (numFFT_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
