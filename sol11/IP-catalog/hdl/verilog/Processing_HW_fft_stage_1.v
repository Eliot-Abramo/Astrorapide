...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_reg_88[19 : 9] <= tmp_fu_74_p3[19 : 9];
    end
end
...
always @ (*) begin
    if (((real_start == 1'b0) | (num_c39_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (num_c39_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        numFFT_read = 1'b1;
    end else begin
        numFFT_read = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (num_c39_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
