...
entity fft_HW_fifo_w64_d1024_A is
    generic (
...
architecture arch of fft_HW_fifo_w64_d1024_A is

    -- component
    component fft_HW_fifo_w64_d1024_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_fft_HW_fifo_w64_d1024_A_ram : fft_HW_fifo_w64_d1024_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity fft_HW_fifo_w64_d1024_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 64;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of fft_HW_fifo_w64_d1024_A_ram is
