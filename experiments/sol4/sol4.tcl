...
#
# sol4.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Sun May 18 02:47:07 CEST 2025
...
#
# 1. This project restoration tcl script (sol4.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/eliot/Documents/University_Documents/BA6/Lab_HW_SW/lab_hw_sw_final/project_1/project_1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/eliot/Documents/University_Documents/BA6/Lab_HW_SW/lab_hw_sw_final/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../constraints.xdc"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../IP-catalog"]"]"\
  ]
  foreach ipath $paths {
...
proc cr_bd_design_1 { parentCell } {
  ...
  set fft_HW_0 [ create_bd_cell -type ip -vlnv MathiasTheBoss:hls:fft_HW:1.0 fft_HW_0 ]
  set_property CONFIG.C_M_AXI_GMEM0_CACHE_VALUE {"1111"} $fft_HW_0
...
\
  ...
  connect_bd_intf_net -intf_net fft_HW_0_m_axi_gmem0 [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins fft_HW_0/m_axi_gmem0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins fft_HW_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins fft_HW_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_HW_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] -force
  assign_bd_address -offset 0xFC000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces fft_HW_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] -force
  ...
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces fft_HW_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP]
  exclude_bd_addr_seg -offset 0x40000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces fft_HW_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.231",
   "Default View_TopLeft":"2,-570",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1900 -y -240 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1900 -y -220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -x 950 -y -160 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -x 1690 -y -100 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 4 -x 1340 -y -60 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -x 1690 -y -440 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 1 -x 220 -y 20 -defaultsOSRD
preplace inst fft_HW_0 -pg 1 -lvl 2 -x 560 -y -300 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 30 -100 360 -100 740 -50 1160 -160 1520
preplace netloc processing_system7_0_FCLK_RESET0_N 1 3 1 1150 -110n
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 5 10 -220 370J -220 750 -270 NJ -270 1530
preplace netloc processing_system7_0_M_AXI_GP0 1 3 2 1150J -170 1540
preplace netloc processing_system7_0_DDR 1 3 3 1150J -250 NJ -250 1880J
preplace netloc processing_system7_0_FIXED_IO 1 3 3 1160J -240 NJ -240 1870J
preplace netloc axi_mem_intercon_M00_AXI 1 2 4 750 40 NJ 40 NJ 40 1860
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 6 20 140 NJ 140 N 140 NJ 140 NJ 140 1840
preplace netloc fft_HW_0_m_axi_gmem0 1 2 3 750 -500 NJ -500 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 5 380 50 NJ 50 NJ 50 NJ 50 1850
levelinfo -pg 1 -10 220 560 950 1340 1690 1900
pagesize -pg 1 -db -bbox -sgen -10 -570 2020 200
"
}
