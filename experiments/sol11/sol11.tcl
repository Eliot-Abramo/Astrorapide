...
#
# Generated by Vivado on Mon May 19 23:21:04 CEST 2025
...
#
#    "/home/rainaldi/Final5/Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/rainaldi/Final5/IpCatalog/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/../IpCatalog/constraints.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../IpCatalog"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../IpCatalog"]" $obj
...
set file "[file normalize "$origin_dir/../IpCatalog/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../IpCatalog/constraints.xdc"
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.783077",
   "Default View_TopLeft":"-128,-428",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1190 -y -150 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1190 -y -130 -defaultsOSRD
preplace port Vp_Vn_0 -pg 1 -lvl 0 -x -10 -y -330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y -100 -defaultsOSRD
preplace inst Processing_HW_0 -pg 1 -lvl 1 -x 240 -y 140 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1010 -y -10 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 650 -y -250 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 1 -x 240 -y -320 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 1010 -y -280 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 40 450 -360 860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 460 -270n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 3 20 50 NJ 50 850
preplace netloc processing_system7_0_DDR 1 1 3 NJ -150 N -150 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -130 840 -160 1170
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ -90 N
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 40 60 NJ 60 830J 130 1170
preplace netloc Vp_Vn_0_1 1 0 1 NJ -330
preplace netloc Processing_HW_0_m_axi_gmem 1 1 2 470J -350 850
preplace netloc axi_mem_intercon_M00_AXI 1 0 4 40 -210 440J -400 NJ -400 1170
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 4 30 30 NJ 30 840J 140 1160
levelinfo -pg 1 -10 240 650 1010 1190
pagesize -pg 1 -db -bbox -sgen -120 -430 1310 220
"
}
