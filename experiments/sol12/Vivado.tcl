...
#
# Generated by Vivado on Tue May 20 03:16:39 CEST 2025
...
#
#    "/home/rainaldi/Final6/Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/rainaldi/Final6/IP_Catalog/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../Vivado/Vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/../IP_Catalog/constraints.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../IP_Catalog"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../IP_Catalog"]" $obj
...
set file "[file normalize "$origin_dir/../IP_Catalog/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../IP_Catalog/constraints.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  MathiasTheBoss:hls:Processing_HW:1.0\
  ...
  # Create instance: Processing_HW_0, and set properties
  set Processing_HW_0 [ create_bd_cell -type ip -vlnv MathiasTheBoss:hls:Processing_HW:1.0 Processing_HW_0 ]
  set_property CONFIG.C_M_AXI_GMEM_CACHE_VALUE {"1111"} $Processing_HW_0
...
\
  ...
  connect_bd_intf_net -intf_net Processing_HW_0_m_axi_gmem [get_bd_intf_pins Processing_HW_0/m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Processing_HW_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Processing_HW_0/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Processing_HW_0/ap_rst_n] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Processing_HW_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] -force
  assign_bd_address -offset 0xFC000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces Processing_HW_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Processing_HW_0/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces Processing_HW_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP]
  exclude_bd_addr_seg -offset 0x40000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces Processing_HW_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.817188",
   "Default View_TopLeft":"-137,-448",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1240 -y -160 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1240 -y -140 -defaultsOSRD
preplace port Vp_Vn_0 -pg 1 -lvl 0 -x -10 -y -350 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y -110 -defaultsOSRD
preplace inst Processing_HW_0 -pg 1 -lvl 1 -x 240 -y 100 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1040 -y -20 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 670 -y -260 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 1040 -y -290 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 1 -x 240 -y -340 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 0 470 -370 860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 480 -280n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 3 20 10 NJ 10 880
preplace netloc processing_system7_0_DDR 1 1 3 450J -380 850 -410 1220
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -140 890 -160 1210
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 NJ -100 N
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 40 180 NJ 180 NJ 180 1190
preplace netloc Processing_HW_0_m_axi_gmem 1 1 2 490J -360 850
preplace netloc axi_mem_intercon_M00_AXI 1 0 4 40 -230 440J -420 NJ -420 1200
preplace netloc Vp_Vn_0_1 1 0 1 NJ -350
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 4 30 -220 460J -160 870J -170 1200
levelinfo -pg 1 -10 240 670 1040 1240
pagesize -pg 1 -db -bbox -sgen -120 -450 1360 200
"
}
