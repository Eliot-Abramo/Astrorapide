...
wire   [9:0] process_U0_num_c42_din;
wire    process_U0_num_c42_write;
...
wire   [9:0] process2_U0_num_c41_din;
wire    process2_U0_num_c41_write;
...
wire   [9:0] load_nfft_value_U0_num_c40_din;
wire    load_nfft_value_U0_num_c40_write;
...
wire   [9:0] fft_stage_1_U0_num_c39_din;
wire    fft_stage_1_U0_num_c39_write;
...
wire   [9:0] fft_stage_2_U0_num_c38_din;
wire    fft_stage_2_U0_num_c38_write;
...
wire   [9:0] fft_stage_3_U0_num_c37_din;
wire    fft_stage_3_U0_num_c37_write;
...
wire   [9:0] fft_stage_4_U0_num_c36_din;
wire    fft_stage_4_U0_num_c36_write;
...
wire   [9:0] fft_stage_5_U0_num_c35_din;
wire    fft_stage_5_U0_num_c35_write;
...
wire   [9:0] fft_stage_6_U0_num_c34_din;
wire    fft_stage_6_U0_num_c34_write;
...
wire   [9:0] fft_stage_7_U0_num_c33_din;
wire    fft_stage_7_U0_num_c33_write;
...
wire   [9:0] fft_stage_8_U0_num_c32_din;
wire    fft_stage_8_U0_num_c32_write;
...
wire   [9:0] fft_stage_9_U0_num_c31_din;
wire    fft_stage_9_U0_num_c31_write;
...
wire   [9:0] fft_stage_10_U0_num_c_din;
...
Processing_HW_process2 process2_U0(
    ...
    .num_dout(num_c42_dout),
    .num_num_data_valid(num_c42_num_data_valid),
    .num_fifo_cap(num_c42_fifo_cap),
    .num_empty_n(num_c42_empty_n),
...
Processing_HW_fifo_w64_d15_S out_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c42_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(process_U0_num_c42_din),
    .if_full_n(num_c42_full_n),
    .if_write(process_U0_num_c42_write),
...
Processing_HW_fifo_w10_d2_S num_c41_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(process2_U0_num_c41_din),
    .if_full_n(num_c41_full_n),
    .if_write(process2_U0_num_c41_write),
...
Processing_HW_fifo_w10_d2_S num_c40_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(load_nfft_value_U0_num_c40_din),
    .if_full_n(num_c40_full_n),
    .if_write(load_nfft_value_U0_num_c40_write),
...
Processing_HW_fifo_w10_d2_S num_c39_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_1_U0_num_c39_din),
    .if_full_n(num_c39_full_n),
    .if_write(fft_stage_1_U0_num_c39_write),
...
Processing_HW_fifo_w10_d2_S num_c38_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_2_U0_num_c38_din),
    .if_full_n(num_c38_full_n),
    .if_write(fft_stage_2_U0_num_c38_write),
...
Processing_HW_fifo_w10_d2_S num_c37_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_3_U0_num_c37_din),
    .if_full_n(num_c37_full_n),
    .if_write(fft_stage_3_U0_num_c37_write),
...
Processing_HW_fifo_w10_d2_S num_c36_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_4_U0_num_c36_din),
    .if_full_n(num_c36_full_n),
    .if_write(fft_stage_4_U0_num_c36_write),
...
Processing_HW_fifo_w10_d2_S num_c35_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_5_U0_num_c35_din),
    .if_full_n(num_c35_full_n),
    .if_write(fft_stage_5_U0_num_c35_write),
...
Processing_HW_fifo_w10_d2_S num_c34_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_6_U0_num_c34_din),
    .if_full_n(num_c34_full_n),
    .if_write(fft_stage_6_U0_num_c34_write),
...
Processing_HW_fifo_w10_d2_S num_c33_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_7_U0_num_c33_din),
    .if_full_n(num_c33_full_n),
    .if_write(fft_stage_7_U0_num_c33_write),
...
Processing_HW_fifo_w10_d2_S num_c32_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_8_U0_num_c32_din),
    .if_full_n(num_c32_full_n),
    .if_write(fft_stage_8_U0_num_c32_write),
...
Processing_HW_fifo_w10_d2_S num_c31_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(fft_stage_9_U0_num_c31_din),
    .if_full_n(num_c31_full_n),
    .if_write(fft_stage_9_U0_num_c31_write),
