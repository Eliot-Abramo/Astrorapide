...
entity Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4 is 
...
attribute shreg_extract : string;
    ...
    signal Twiddle_re13_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal Twiddle_re13_ce0 : STD_LOGIC;
    signal Twiddle_re13_q0 : STD_LOGIC_VECTOR (23 downto 0);
    signal Twiddle_im14_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal Twiddle_im14_ce0 : STD_LOGIC;
    signal Twiddle_im14_q0 : STD_LOGIC_VECTOR (22 downto 0);
    signal S11_blk_n : STD_LOGIC;
    ...
    signal this_re_V_7_load_reg_377 : STD_LOGIC_VECTOR (23 downto 0);
    signal this_im_V_7_load_reg_382 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal sext_ln1270_9_fu_234_p1 : STD_LOGIC_VECTOR (53 downto 0);
    signal sext_ln1270_9_reg_404 : STD_LOGIC_VECTOR (53 downto 0);
    signal sext_ln1273_9_fu_237_p1 : STD_LOGIC_VECTOR (53 downto 0);
    signal sext_ln1273_9_reg_410 : STD_LOGIC_VECTOR (53 downto 0);
    ...
    signal tmp_re_V_29_fu_294_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_re_V_29_reg_447 : STD_LOGIC_VECTOR (31 downto 0);
    signal a_im_V_reg_453 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_im_V_29_fu_298_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_im_V_29_reg_459 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_re_V_27_fu_302_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_re_V_27_reg_465 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal zext_ln541_fu_211_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal ii_V_fu_60 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln840_fu_187_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_ii_V_10 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal lhs_V_fu_199_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_fu_203_p3 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_im_V_27_fu_311_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4_Twiddle_re13_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
    ...
    component Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4_Twiddle_im14_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    Twiddle_re13_U : component Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4_Twiddle_re13_ROM_AUTO_1R
    generic map (
        DataWidth => 24,
        AddressRange => 1024,
        AddressWidth => 10)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => Twiddle_re13_address0,
        ce0 => Twiddle_re13_ce0,
        q0 => Twiddle_re13_q0);

    Twiddle_im14_U : component Processing_HW_fft_stage_11_Pipeline_VITIS_LOOP_2582_4_Twiddle_im14_ROM_AUTO_1R
    generic map (
        DataWidth => 23,
        AddressRange => 1024,
        AddressWidth => 10)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => Twiddle_im14_address0,
        ce0 => Twiddle_im14_ce0,
        q0 => Twiddle_im14_q0);

    mul_32s_24s_54_2_1_U341 : component Processing_HW_mul_32s_24s_54_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din1 => this_re_V_7_load_reg_377,
        ce => grp_fu_228_ce,
        dout => grp_fu_228_p2);

    mul_32s_23s_54_2_1_U342 : component Processing_HW_mul_32s_23s_54_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din1 => this_im_V_7_load_reg_382,
        ce => grp_fu_240_ce,
        dout => grp_fu_240_p2);

    mul_32s_23s_54_2_1_U343 : component Processing_HW_mul_32s_23s_54_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mul_32s_24s_54_2_1_U344 : component Processing_HW_mul_32s_24s_54_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                sext_ln1270_9_reg_404 <= sext_ln1270_9_fu_234_p1;
                sext_ln1270_reg_392 <= sext_ln1270_fu_222_p1;
                sext_ln1273_9_reg_410 <= sext_ln1273_9_fu_237_p1;
                ...
                tmp_re_V_29_reg_447 <= tmp_re_V_29_fu_294_p2;
                    zext_ln1027_reg_339_pp0_iter1_reg(10 downto 0) <= zext_ln1027_reg_339(10 downto 0);
                    zext_ln1027_reg_339_pp0_iter2_reg(10 downto 0) <= zext_ln1027_reg_339_pp0_iter1_reg(10 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1027_reg_335 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                this_im_V_7_load_reg_382 <= Twiddle_im14_q0;
                this_re_V_7_load_reg_377 <= Twiddle_re13_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                ...
                tmp_im_V_29_reg_459 <= tmp_im_V_29_fu_298_p2;
                tmp_re_V_27_reg_465 <= tmp_re_V_27_fu_302_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1027_fu_181_p2 = ap_const_lv1_0))) then
                    zext_ln1027_reg_339(10 downto 0) <= zext_ln1027_fu_193_p1(10 downto 0);
            end if;
        end if;
    end process;
    zext_ln1027_reg_339(63 downto 11) <= "00000000000000000000000000000000000000000000000000000";
    zext_ln1027_reg_339_pp0_iter1_reg(63 downto 11) <= "00000000000000000000000000000000000000000000000000000";
    zext_ln1027_reg_339_pp0_iter2_reg(63 downto 11) <= "00000000000000000000000000000000000000000000000000000";
    ...
    In_im_V_address0 <= zext_ln1027_reg_339_pp0_iter1_reg(11 - 1 downto 0);
    In_im_V_address1 <= zext_ln541_fu_211_p1(11 - 1 downto 0);
    ...
    In_re_V_address0 <= zext_ln1027_reg_339(11 - 1 downto 0);
    In_re_V_address1 <= zext_ln541_fu_211_p1(11 - 1 downto 0);
    ...
    OutBuff_im_V_address0 <= zext_ln1027_reg_339_pp0_iter2_reg(10 - 1 downto 0);
    ...
    OutBuff_im_V_d0 <= std_logic_vector(unsigned(a_im_V_reg_453) - unsigned(tmp_im_V_29_reg_459));
    ...
    OutBuff_re_V_address0 <= zext_ln1027_reg_339_pp0_iter2_reg(10 - 1 downto 0);
    ...
    OutBuff_re_V_d0 <= std_logic_vector(unsigned(a_re_V_reg_416) - unsigned(tmp_re_V_29_reg_447));
    ...
    S11_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, S11_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            S11_blk_n <= S11_full_n;
        else 
            S11_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    S11_din <= (tmp_im_V_27_fu_311_p2 & tmp_re_V_27_reg_465);

    S11_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            S11_write <= ap_const_logic_1;
        else 
            S11_write <= ap_const_logic_0;
        end if; 
    end process;

    Twiddle_im14_address0 <= zext_ln1027_fu_193_p1(10 - 1 downto 0);

    Twiddle_im14_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            Twiddle_im14_ce0 <= ap_const_logic_1;
        else 
            Twiddle_im14_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    Twiddle_re13_address0 <= zext_ln1027_fu_193_p1(10 - 1 downto 0);

    Twiddle_re13_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            Twiddle_re13_ce0 <= ap_const_logic_1;
        else 
            Twiddle_re13_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    add_ln840_fu_187_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_ii_V_10) + unsigned(ap_const_lv11_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
    ap_CS_fsm_pp0_stage1 <= ap_CS_fsm(1);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter3, S11_full_n)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_const_logic_0 = S11_full_n) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter3, S11_full_n)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_const_logic_0 = S11_full_n) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter3, S11_full_n)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_const_logic_0 = S11_full_n) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1));
    end process;
    ...
    ap_block_state7_pp0_stage0_iter3_assign_proc : process(S11_full_n)
    begin
                ap_block_state7_pp0_stage0_iter3 <= (ap_const_logic_0 = S11_full_n);
    end process;
    ...
    ap_sig_allocacmp_ii_V_10_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ii_V_fu_60, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_ii_V_10 <= ap_const_lv11_0;
        else 
            ap_sig_allocacmp_ii_V_10 <= ii_V_fu_60;
        end if; 
    end process;
    ...
    grp_fu_266_p1 <= sext_ln1273_9_reg_410(23 - 1 downto 0);
    ...
    grp_fu_270_p0 <= sext_ln1270_9_reg_404(32 - 1 downto 0);
    grp_fu_270_p1 <= sext_ln1273_reg_398(24 - 1 downto 0);
    icmp_ln1027_fu_181_p2 <= "1" when (ap_sig_allocacmp_ii_V_10 = ap_const_lv11_400) else "0";
    lhs_V_fu_199_p1 <= ap_sig_allocacmp_ii_V_10(10 - 1 downto 0);
    ret_V_fu_203_p3 <= (ap_const_lv1_1 & lhs_V_fu_199_p1);
        sext_ln1270_9_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_im_V_reg_372),54));

        sext_ln1270_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_re_V_reg_367),54));

        sext_ln1273_9_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(this_im_V_7_load_reg_382),54));

        sext_ln1273_fu_225_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(this_re_V_7_load_reg_377),54));

    tmp_im_V_27_fu_311_p2 <= std_logic_vector(unsigned(a_im_V_reg_453) + unsigned(tmp_im_V_29_reg_459));
    tmp_im_V_29_fu_298_p2 <= std_logic_vector(unsigned(tmp3_V_reg_437) + unsigned(tmp4_V_reg_442));
    tmp_re_V_27_fu_302_p2 <= std_logic_vector(unsigned(a_re_V_reg_416) + unsigned(tmp_re_V_29_reg_447));
    tmp_re_V_29_fu_294_p2 <= std_logic_vector(unsigned(tmp1_V_reg_422) - unsigned(tmp2_V_reg_427));
    zext_ln1027_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_ii_V_10),64));
