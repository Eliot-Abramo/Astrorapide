...
wire   [9:0] process_U0_num_c45_din;
wire    process_U0_num_c45_write;
...
wire   [9:0] load_nfft_value_U0_num_c43_din;
wire    load_nfft_value_U0_num_c43_write;
...
wire   [9:0] fft_stage_1_U0_num_c42_din;
wire    fft_stage_1_U0_num_c42_write;
...
wire   [9:0] fft_stage_2_U0_num_c41_din;
wire    fft_stage_2_U0_num_c41_write;
...
wire   [9:0] fft_stage_3_U0_num_c40_din;
wire    fft_stage_3_U0_num_c40_write;
...
wire   [9:0] fft_stage_4_U0_num_c39_din;
wire    fft_stage_4_U0_num_c39_write;
...
wire   [9:0] fft_stage_5_U0_num_c38_din;
wire    fft_stage_5_U0_num_c38_write;
...
wire   [9:0] fft_stage_6_U0_num_c37_din;
wire    fft_stage_6_U0_num_c37_write;
...
wire   [9:0] fft_stage_7_U0_num_c36_din;
wire    fft_stage_7_U0_num_c36_write;
...
wire   [9:0] fft_stage_8_U0_num_c35_din;
wire    fft_stage_8_U0_num_c35_write;
...
wire   [9:0] fft_stage_9_U0_num_c34_din;
wire    fft_stage_9_U0_num_c34_write;
...
wire    fft_stage_10_U0_start_out;
wire    fft_stage_10_U0_start_write;
...
wire   [9:0] fft_stage_10_U0_num_c33_din;
wire    fft_stage_10_U0_num_c33_write;
wire    fft_stage_11_U0_ap_start;
wire    fft_stage_11_U0_ap_done;
wire    fft_stage_11_U0_ap_continue;
wire    fft_stage_11_U0_ap_idle;
wire    fft_stage_11_U0_ap_ready;
wire    fft_stage_11_U0_S10_read;
wire   [63:0] fft_stage_11_U0_S11_din;
wire    fft_stage_11_U0_S11_write;
wire    fft_stage_11_U0_numFFT_read;
wire   [9:0] fft_stage_11_U0_num_c_din;
wire    fft_stage_11_U0_num_c_write;
...
wire    retrieve_nfft_value_U0_S11_read;
...
wire   [0:0] start_for_fft_stage_11_U0_din;
wire    start_for_fft_stage_11_U0_full_n;
wire   [0:0] start_for_fft_stage_11_U0_dout;
wire    start_for_fft_stage_11_U0_empty_n;
wire    ap_ce_reg;
...
Processing_HW_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Processing_HW_fft_stage_11 fft_stage_11_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Processing_HW_retrieve_nfft_value retrieve_nfft_value_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Processing_HW_fifo_w64_d16_S out_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A D0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c45_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A D1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c44_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c43_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c42_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c41_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c40_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c39_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S5_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c38_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S6_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c37_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S7_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c36_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S8_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c35_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S9_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c34_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S10_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c33_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w64_d2048_A S11_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_fifo_w10_d2_S num_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_start_for_retrieve_nfft_value_U0 start_for_retrieve_nfft_value_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Processing_HW_start_for_fft_stage_11_U0 start_for_fft_stage_11_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Buff0_im_address1 = 11'd0;
...
assign Buff0_re_address1 = 11'd0;
...
assign Buff1_im_address1 = 11'd0;
...
assign Buff1_re_address1 = 11'd0;
...
assign Buff2_im_address1 = 11'd0;
...
assign Buff2_re_address1 = 11'd0;
...
assign ap_idle = (retrieve_nfft_value_U0_ap_idle & process_U0_ap_idle & process2_U0_ap_idle & load_nfft_value_U0_ap_idle & fft_stage_9_U0_ap_idle & fft_stage_8_U0_ap_idle & fft_stage_7_U0_ap_idle & fft_stage_6_U0_ap_idle & fft_stage_5_U0_ap_idle & fft_stage_4_U0_ap_idle & fft_stage_3_U0_ap_idle & fft_stage_2_U0_ap_idle & fft_stage_1_U0_ap_idle & fft_stage_11_U0_ap_idle & fft_stage_10_U0_ap_idle & entry_proc_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_done = (retrieve_nfft_value_U0_ap_done & process2_U0_ap_done);
...
assign ap_sync_ready = (ap_sync_process_U0_ap_ready & ap_sync_process2_U0_ap_ready & ap_sync_entry_proc_U0_ap_ready);
...
assign fft_stage_11_U0_ap_continue = 1'b1;

assign fft_stage_11_U0_ap_start = start_for_fft_stage_11_U0_empty_n;
