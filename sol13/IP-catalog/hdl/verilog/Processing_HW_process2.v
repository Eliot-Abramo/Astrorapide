...
output  [9:0] num_c44_din;
input  [1:0] num_c44_num_data_valid;
input  [1:0] num_c44_fifo_cap;
input   num_c44_full_n;
output   num_c44_write;
...
reg D1_write;
reg num_read;
reg[10:0] Buff0_re_address0;
reg Buff0_re_ce0;
reg Buff0_re_we0;
reg[10:0] Buff0_im_address0;
reg Buff0_im_ce0;
reg Buff0_im_we0;
reg[10:0] Buff1_re_address0;
reg Buff1_re_ce0;
reg Buff1_re_we0;
reg[10:0] Buff1_im_address0;
reg Buff1_im_ce0;
reg Buff1_im_we0;
reg[10:0] Buff2_re_address0;
reg Buff2_re_ce0;
reg Buff2_re_we0;
reg[10:0] Buff2_im_address0;
reg Buff2_im_ce0;
reg Buff2_im_we0;
reg num_c44_write;
...
reg   [10:0] Buff3_re_V_address0;
reg    Buff3_re_V_ce0;
reg    Buff3_re_V_we0;
wire   [31:0] Buff3_re_V_q0;
reg   [10:0] Buff3_im_V_address0;
reg    Buff3_im_V_ce0;
reg    Buff3_im_V_we0;
wire   [31:0] Buff3_im_V_q0;
...
wire   [10:0] grp_Windowing_fu_108_Buff3_im_address0;
...
Processing_HW_process2_Buff3_re_V_RAM_AUTO_1R1W #(
    .DataWidth( 32 ),
    .AddressRange( 2048 ),
    .AddressWidth( 11 ))
Buff3_re_V_U(
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c44_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c44_full_n == 1'b0))) begin
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c44_full_n == 1'b0));
end
