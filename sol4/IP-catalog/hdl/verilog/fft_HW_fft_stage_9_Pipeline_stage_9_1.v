...
module fft_HW_fft_stage_9_Pipeline_stage_9_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln861_fu_233_p1;
...
wire   [31:0] bitcast_ln862_1_fu_247_p1;
wire   [31:0] bitcast_ln862_fu_244_p1;
...
fft_HW_fft_stage_9_Pipeline_stage_9_1_Twiddle_re9_ROM_AUTO_1R #(
    .DataWidth( 32 ),
    .AddressRange( 256 ),
    .AddressWidth( 8 ))
Twiddle_re9_U(
...
fft_HW_fft_stage_9_Pipeline_stage_9_1_Twiddle_im10_ROM_AUTO_1R #(
    .DataWidth( 32 ),
    .AddressRange( 256 ),
    .AddressWidth( 8 ))
Twiddle_im10_U(
...
fft_HW_faddfsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
faddfsub_32ns_32ns_32_5_full_dsp_1_U212(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_177_p0),
    .din1(grp_fu_177_p1),
...
fft_HW_fsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_5_full_dsp_1_U214(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_185_p0),
    .din1(grp_fu_185_p1),
...
assign In_im_1_address0 = zext_ln861_fu_233_p1;

assign In_im_address0 = zext_ln1027_reg_270_pp0_iter4_reg;

assign In_re_1_address0 = zext_ln861_fu_233_p1;
...
assign S9_din = {{bitcast_ln862_1_fu_247_p1}, {bitcast_ln862_fu_244_p1}};
...
assign bitcast_ln862_1_fu_247_p1 = tmp_im_1_reg_379;

assign bitcast_ln862_fu_244_p1 = tmp_re_1_reg_374;
...
assign zext_ln861_fu_233_p1 = lhs_V_fu_229_p1;
...
endmodule //fft_HW_fft_stage_9_Pipeline_stage_9_1
