...
// ==============================================================
`timescale 1ns/1ps
module Processing_HW_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_NUMFFT_DATA_0   = 6'h28,
    ADDR_NUMFFT_CTRL     = 6'h2c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NUMFFT_DATA_0: begin
                    rdata <= int_numFFT[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NUMFFT_DATA_0)
            int_numFFT[31:0] <= (WDATA[31:0] & wmask) | (int_numFFT[31:0] & ~wmask);
    end
end
