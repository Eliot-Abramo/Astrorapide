...
reg    numFFT_blk_n;
reg    num_c44_blk_n;
reg   [31:0] numFFT_read_reg_83;
wire   [41:0] tmp_fu_74_p3;
reg   [41:0] tmp_reg_88;
...
reg    ap_block_state1;
wire   [32:0] numFFT_cast_fu_65_p1;
wire   [32:0] sub_i_i_fu_68_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_reg_88[41 : 9] <= tmp_fu_74_p3[41 : 9];
    end
end
...
always @ (*) begin
    if (((real_start == 1'b0) | (num_c44_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (num_c44_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        numFFT_read = 1'b1;
    end else begin
        numFFT_read = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (num_c44_full_n == 1'b0) | (numFFT_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign numFFT_cast_fu_65_p1 = numFFT_read_reg_83;

assign num_c44_din = numFFT_dout;

assign start_out = real_start;

assign sub_i_i_fu_68_p2 = ($signed(numFFT_cast_fu_65_p1) + $signed(33'd8589934589));

assign tmp_fu_74_p3 = {{sub_i_i_fu_68_p2}, {9'd0}};

always @ (posedge ap_clk) begin
    tmp_reg_88[8:0] <= 9'b000000000;
end
