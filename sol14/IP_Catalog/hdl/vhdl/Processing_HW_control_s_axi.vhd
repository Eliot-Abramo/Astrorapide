...
--        bit 31~0 - numFFT[31:0] (Read/Write)
-- 0x2c : reserved
...
architecture behave of Processing_HW_control_s_axi is
    ...
    signal int_numFFT          : UNSIGNED(31 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_NUMFFT_DATA_0 =>
                        rdata_data <= RESIZE(int_numFFT(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NUMFFT_DATA_0) then
                    int_numFFT(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_numFFT(31 downto 0));
                end if;
            end if;
        end if;
    end process;
