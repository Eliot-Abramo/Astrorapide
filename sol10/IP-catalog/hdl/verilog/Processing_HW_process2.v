...
reg    num_blk_n;
reg    num_c41_blk_n;
wire   [10:0] sub_i_i_fu_162_p2;
reg   [10:0] sub_i_i_reg_206;
wire   [1:0] ret_V_fu_176_p1;
reg   [1:0] ret_V_reg_211;
wire    ap_CS_fsm_state2;
wire   [9:0] counter_V_2_fu_189_p2;
reg   [9:0] counter_V_2_reg_218;
...
wire    grp_Windowing_fu_108_ap_start;
wire    grp_Windowing_fu_108_ap_done;
wire    grp_Windowing_fu_108_ap_idle;
wire    grp_Windowing_fu_108_ap_ready;
wire   [9:0] grp_Windowing_fu_108_Buff0_re_address0;
wire    grp_Windowing_fu_108_Buff0_re_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff0_re_q0;
wire   [9:0] grp_Windowing_fu_108_Buff0_im_address0;
wire    grp_Windowing_fu_108_Buff0_im_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff0_im_q0;
wire   [9:0] grp_Windowing_fu_108_Buff1_re_address0;
wire    grp_Windowing_fu_108_Buff1_re_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff1_re_q0;
wire   [9:0] grp_Windowing_fu_108_Buff1_im_address0;
wire    grp_Windowing_fu_108_Buff1_im_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff1_im_q0;
wire   [9:0] grp_Windowing_fu_108_Buff2_re_address0;
wire    grp_Windowing_fu_108_Buff2_re_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff2_re_q0;
wire   [9:0] grp_Windowing_fu_108_Buff2_im_address0;
wire    grp_Windowing_fu_108_Buff2_im_ce0;
reg   [31:0] grp_Windowing_fu_108_Buff2_im_q0;
wire   [9:0] grp_Windowing_fu_108_Buff3_re_address0;
wire    grp_Windowing_fu_108_Buff3_re_ce0;
wire    grp_Windowing_fu_108_Buff3_re_we0;
wire   [31:0] grp_Windowing_fu_108_Buff3_re_d0;
reg   [31:0] grp_Windowing_fu_108_Buff3_re_q0;
wire   [9:0] grp_Windowing_fu_108_Buff3_im_address0;
wire    grp_Windowing_fu_108_Buff3_im_ce0;
wire    grp_Windowing_fu_108_Buff3_im_we0;
wire   [31:0] grp_Windowing_fu_108_Buff3_im_d0;
reg   [31:0] grp_Windowing_fu_108_Buff3_im_q0;
wire    grp_Windowing_fu_108_D0_read;
wire   [63:0] grp_Windowing_fu_108_D1_din;
wire    grp_Windowing_fu_108_D1_write;
reg    grp_Windowing_fu_108_ap_start_reg;
wire   [0:0] icmp_ln1027_fu_184_p2;
wire    ap_CS_fsm_state3;
reg   [9:0] counter_V_fu_82;
reg    ap_block_state3_on_subcall_done;
reg    ap_block_state1;
wire   [10:0] num_cast2_fu_158_p1;
wire   [10:0] zext_ln1027_fu_180_p1;
reg   [2:0] ap_NS_fsm;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 3'd1;
#0 grp_Windowing_fu_108_ap_start_reg = 1'b0;
end
...
Processing_HW_Windowing grp_Windowing_fu_108(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_Windowing_fu_108_ap_start_reg <= 1'b0;
    end else begin
        if ((((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd1) & (ret_V_fu_176_p1 == 2'd3)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd1) & (ret_V_fu_176_p1 == 2'd0)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd1) & (ret_V_fu_176_p1 == 2'd1)) | ((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd1) & (ret_V_fu_176_p1 == 2'd2)))) begin
            grp_Windowing_fu_108_ap_start_reg <= 1'b1;
        end else if ((grp_Windowing_fu_108_ap_ready == 1'b1)) begin
            grp_Windowing_fu_108_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c41_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd3))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd0)) begin
            Buff3_im_address0 = grp_Windowing_fu_108_Buff3_im_address0;
        end else if ((ret_V_reg_211 == 2'd1)) begin
            Buff3_im_address0 = grp_Windowing_fu_108_Buff2_im_address0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            Buff3_im_address0 = grp_Windowing_fu_108_Buff1_im_address0;
        end else if ((ret_V_reg_211 == 2'd3)) begin
            Buff3_im_address0 = grp_Windowing_fu_108_Buff0_im_address0;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd0)) begin
            ...
            Buff3_im_ce0 = grp_Windowing_fu_108_Buff2_im_ce0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            Buff3_im_ce0 = grp_Windowing_fu_108_Buff1_im_ce0;
        end else if ((ret_V_reg_211 == 2'd3)) begin
            Buff3_im_ce0 = grp_Windowing_fu_108_Buff0_im_ce0;
        end else begin
            Buff3_im_ce0 = 1'b0;
        end
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd0))) begin
        Buff3_im_we0 = grp_Windowing_fu_108_Buff3_im_we0;
    end else begin
        Buff3_im_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd0)) begin
            ...
            Buff3_re_address0 = grp_Windowing_fu_108_Buff2_re_address0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            Buff3_re_address0 = grp_Windowing_fu_108_Buff1_re_address0;
        end else if ((ret_V_reg_211 == 2'd3)) begin
            Buff3_re_address0 = grp_Windowing_fu_108_Buff0_re_address0;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd0)) begin
            ...
            Buff3_re_ce0 = grp_Windowing_fu_108_Buff2_re_ce0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            Buff3_re_ce0 = grp_Windowing_fu_108_Buff1_re_ce0;
        end else if ((ret_V_reg_211 == 2'd3)) begin
            Buff3_re_ce0 = grp_Windowing_fu_108_Buff0_re_ce0;
        end else begin
            Buff3_re_ce0 = 1'b0;
        end
    end else begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd3)) | ((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd0)) | ((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd1)) | ((1'b1 == ap_CS_fsm_state3) & (ret_V_reg_211 == 2'd2)))) begin
        D0_read = grp_Windowing_fu_108_D0_read;
    end else begin
        D0_read = 1'b0;
    end
...
always @ (*) begin
    if (((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c41_full_n == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1027_fu_184_p2 == 1'd0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            grp_Windowing_fu_108_Buff0_im_q0 = Buff3_im_q0;
        end else if ((ret_V_reg_211 == 2'd0)) begin
            ...
            grp_Windowing_fu_108_Buff0_im_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff0_im_q0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            grp_Windowing_fu_108_Buff0_re_q0 = Buff3_re_q0;
        end else if ((ret_V_reg_211 == 2'd0)) begin
            ...
            grp_Windowing_fu_108_Buff0_re_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff0_re_q0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            ...
            grp_Windowing_fu_108_Buff1_im_q0 = Buff3_im_q0;
        end else begin
            grp_Windowing_fu_108_Buff1_im_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff1_im_q0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            ...
            grp_Windowing_fu_108_Buff1_re_q0 = Buff3_re_q0;
        end else begin
            grp_Windowing_fu_108_Buff1_re_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff1_re_q0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            ...
            grp_Windowing_fu_108_Buff2_im_q0 = Buff3_im_q0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            grp_Windowing_fu_108_Buff2_im_q0 = Buff0_im_q0;
        end else begin
            grp_Windowing_fu_108_Buff2_im_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff2_im_q0 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((ret_V_reg_211 == 2'd3)) begin
            ...
            grp_Windowing_fu_108_Buff2_re_q0 = Buff3_re_q0;
        end else if ((ret_V_reg_211 == 2'd2)) begin
            grp_Windowing_fu_108_Buff2_re_q0 = Buff0_re_q0;
        end else begin
            grp_Windowing_fu_108_Buff2_re_q0 = 'bx;
        end
    end else begin
        grp_Windowing_fu_108_Buff2_re_q0 = 'bx;
    end
...
assign Buff0_im_d0 = grp_Windowing_fu_108_Buff3_im_d0;

assign Buff0_re_d0 = grp_Windowing_fu_108_Buff3_re_d0;

assign Buff1_im_d0 = grp_Windowing_fu_108_Buff3_im_d0;

assign Buff1_re_d0 = grp_Windowing_fu_108_Buff3_re_d0;

assign Buff2_im_d0 = grp_Windowing_fu_108_Buff3_im_d0;

assign Buff2_re_d0 = grp_Windowing_fu_108_Buff3_re_d0;

assign D1_din = grp_Windowing_fu_108_D1_din;
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (num_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (num_c41_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state3_on_subcall_done = (((grp_Windowing_fu_108_ap_done == 1'b0) & (ret_V_reg_211 == 2'd3)) | ((grp_Windowing_fu_108_ap_done == 1'b0) & (ret_V_reg_211 == 2'd0)) | ((grp_Windowing_fu_108_ap_done == 1'b0) & (ret_V_reg_211 == 2'd1)) | ((grp_Windowing_fu_108_ap_done == 1'b0) & (ret_V_reg_211 == 2'd2)));
end

assign ap_ready = internal_ap_ready;

assign counter_V_2_fu_189_p2 = (counter_V_fu_82 + 10'd1);

assign grp_Windowing_fu_108_ap_start = grp_Windowing_fu_108_ap_start_reg;

assign icmp_ln1027_fu_184_p2 = (($signed(sub_i_i_reg_206) > $signed(zext_ln1027_fu_180_p1)) ? 1'b1 : 1'b0);

assign num_c41_din = num_dout;

assign num_cast2_fu_158_p1 = num_dout;

assign ret_V_fu_176_p1 = counter_V_fu_82[1:0];

assign start_out = real_start;

assign sub_i_i_fu_162_p2 = ($signed(num_cast2_fu_158_p1) + $signed(11'd2045));

assign zext_ln1027_fu_180_p1 = counter_V_fu_82;
