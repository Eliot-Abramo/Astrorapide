...
module fft_HW_fft_stage_10_Pipeline_stage_10_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input   S10_full_n;
output   S10_write;
output  [8:0] In_re_address0;
output   In_re_ce0;
input  [31:0] In_re_q0;
output  [8:0] In_im_address0;
output   In_im_ce0;
input  [31:0] In_im_q0;
output  [8:0] In_re_1_address0;
output   In_re_1_ce0;
input  [31:0] In_re_1_q0;
output  [8:0] In_im_1_address0;
output   In_im_1_ce0;
input  [31:0] In_im_1_q0;
output  [8:0] OutBuff_re_address0;
output   OutBuff_re_ce0;
output   OutBuff_re_we0;
output  [31:0] OutBuff_re_d0;
output  [8:0] OutBuff_im_address0;
...
wire   [31:0] Twiddle_re11_q0;
wire   [8:0] Twiddle_im12_address0;
reg    Twiddle_im12_ce0;
wire   [31:0] Twiddle_im12_q0;
reg    S10_blk_n;
...
reg   [31:0] tmp_re_30_reg_356;
reg   [31:0] a_im_reg_362;
reg   [31:0] tmp_im_30_reg_368;
wire   [31:0] grp_fu_181_p2;
reg   [31:0] tmp_re_28_reg_374;
reg   [31:0] tmp_im_28_reg_379;
reg    ap_enable_reg_pp0_iter0_reg;
wire   [63:0] zext_ln1434_fu_233_p1;
wire    ap_block_pp0_stage0;
reg   [9:0] ii_V_fu_62;
wire   [9:0] add_ln840_fu_217_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_ii_V_10;
...
wire   [8:0] lhs_V_fu_229_p1;
wire   [31:0] bitcast_ln1435_1_fu_247_p1;
wire   [31:0] bitcast_ln1435_fu_244_p1;
...
fft_HW_fft_stage_10_Pipeline_stage_10_1_Twiddle_re11_ROM_AUTO_1R #(
    .DataWidth( 32 ),
    .AddressRange( 512 ),
    .AddressWidth( 9 ))
Twiddle_re11_U(
...
fft_HW_fft_stage_10_Pipeline_stage_10_1_Twiddle_im12_ROM_AUTO_1R #(
    .DataWidth( 32 ),
    .AddressRange( 512 ),
    .AddressWidth( 9 ))
Twiddle_im12_U(
...
fft_HW_faddfsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
faddfsub_32ns_32ns_32_5_full_dsp_1_U238(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_177_p0),
    .din1(grp_fu_177_p1),
...
fft_HW_fsub_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_5_full_dsp_1_U240(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_185_p0),
    .din1(grp_fu_185_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln1027_reg_270_pp0_iter1_reg[9 : 0] <= zext_ln1027_reg_270[9 : 0];
        zext_ln1027_reg_270_pp0_iter2_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter1_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter3_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter2_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter4_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter3_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter5_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter4_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter6_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter5_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter7_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter6_reg[9 : 0];
        zext_ln1027_reg_270_pp0_iter8_reg[9 : 0] <= zext_ln1027_reg_270_pp0_iter7_reg[9 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1027_fu_211_p2 == 1'd0))) begin
        zext_ln1027_reg_270[9 : 0] <= zext_ln1027_fu_223_p1[9 : 0];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_ii_V_10 = 10'd0;
    end else begin
...
assign In_im_1_address0 = zext_ln1434_fu_233_p1;

assign In_im_address0 = zext_ln1027_reg_270_pp0_iter4_reg;

assign In_re_1_address0 = zext_ln1434_fu_233_p1;
...
assign S10_din = {{bitcast_ln1435_1_fu_247_p1}, {bitcast_ln1435_fu_244_p1}};

assign Twiddle_im12_address0 = zext_ln1027_fu_223_p1;

assign Twiddle_re11_address0 = zext_ln1027_fu_223_p1;

assign add_ln840_fu_217_p2 = (ap_sig_allocacmp_ii_V_10 + 10'd1);
...
always @ (*) begin
    ap_block_pp0_stage1_00001 = ((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == S10_full_n));
end

always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == S10_full_n));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == S10_full_n));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter8 == 1'b1) & (1'b0 == S10_full_n));
end
...
always @ (*) begin
    ap_block_state18_pp0_stage1_iter8 = (1'b0 == S10_full_n);
end
...
assign bitcast_ln1435_1_fu_247_p1 = tmp_im_28_reg_379;

assign bitcast_ln1435_fu_244_p1 = tmp_re_28_reg_374;

assign icmp_ln1027_fu_211_p2 = ((ap_sig_allocacmp_ii_V_10 == 10'd512) ? 1'b1 : 1'b0);

assign lhs_V_fu_229_p1 = ap_sig_allocacmp_ii_V_10[8:0];

assign zext_ln1027_fu_223_p1 = ap_sig_allocacmp_ii_V_10;

assign zext_ln1434_fu_233_p1 = lhs_V_fu_229_p1;

always @ (posedge ap_clk) begin
    zext_ln1027_reg_270[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter1_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter2_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter3_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter4_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter5_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter6_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter7_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
    zext_ln1027_reg_270_pp0_iter8_reg[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end

endmodule //fft_HW_fft_stage_10_Pipeline_stage_10_1
